...
# ==========================================
# 5. ORCHESTRATION PIPELINE (STRICT SERIAL MODE)
# ==========================================
...
async def execute_debate_pipeline(paper_file):
    """Orchestrates the workflow serially, saves to Drive, and prints to console."""
...
# 6. EXECUTION
# ==========================================
# Once you have run the upload code above and `paper1` is defined:
