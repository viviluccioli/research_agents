# -*- coding: utf-8 -*-
# workflow.py - Experiment 5 Multi-Agent Referee Report UI
"""
Experiment 5 UI for the multi-agent debate (MAD) referee report system.
...
# Import from local exp-5 engine
from exp_5.engine import execute_debate_pipeline, SELECTION_PROMPT, SYSTEM_PROMPTS, DEBATE_PROMPTS
