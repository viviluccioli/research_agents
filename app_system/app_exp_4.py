...
def _ensure_session_keys():
    ...
    # Initialize widget states to prevent KeyError on first load
    if "paste_format_radio" not in st.session_state:
        st.session_state.paste_format_radio = "Plain text"
    if "paste_text_area" not in st.session_state:
        st.session_state.paste_text_area = ""
